...
Developer GuidesMessage cardsBuild card with JSONCard JSON 1.0 version componentsComponent overview
Component overview
Copy Page
...
{
  "tag": "" // Declare the component tag here. Different components have different tags.
}
Container Components
...
Previous:Card JSON 1.0 structure
Next:Column set
